    ...
    public static class SpriteOptimizerUtils
    {
        public static GUIStyle SetButtonStyle()
        {
            var buttonStyle = new GUIStyle(GUI.skin.button)
            {
                ...
                normal =
                {
                    textColor = new(0.35f, 0.9f, 0.11f)
                },
                hover =
                {
                    textColor = new(0.07f, 1f, 0.58f)
                },
                active =
                {
                    textColor = new(0.18f, 0.5f, 0.4f)
                },
            ...
            if(Event.current.type == EventType.Repaint)
            {
                ...
                buttonStyle.hover.textColor = new(0.84f, 0.9f, 0.03f);
            }

            return buttonStyle;
        }

        public static GUIStyle SetTextFieldStyle() =>
